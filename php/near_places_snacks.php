...
while($row_vendor_loc= mysqli_fetch_array($vendor_loc_query)){$vendor_id=$row_vendor_loc['id'];
  ...
  $vendor_foods="SELECT * FROM snacks where id='$vendor_id'";
  $vendor_foods_query=mysqli_query($link,$vendor_foods);
      ...
      echo "<td><a style=\"text-decoration: none;\" href='make_order_snacks.php?id=".$row_vendor_foods['food_id']."'>Make order</a></td>";
      echo "</tr>";
  }
}
