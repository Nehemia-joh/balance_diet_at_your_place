...
include "link.php";
$id=$_GET['id'];
$foods="SELECT * FROM snacks where food_id='$id'";
...
<?php
    if(isset($_POST['submit1'])){
        ...
        $query="UPDATE snacks SET proteins='$pro',carbohydrates='$carbohydrates' ,vitmins='$Vitamins',fats='$Fats',minerals='$Minerals',fiber='$Fiber',how_it_read='$how_it_read',Additional='$additional',Price='$price' WHERE food_id='$id'";
