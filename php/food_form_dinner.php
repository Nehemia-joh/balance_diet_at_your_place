...
<div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="submit" class="btn btn-primary w-100" value="Save food" name="submit1">
</form>   
...
<?php
    if(isset($_POST['submit1'])){
        ...
        $query="INSERT INTO dinner (id,proteins,carbohydrates,vitmins,fats,minerals,fiber,how_it_read,Additional,Price) VALUES ('$id','$pro','$carbohydrates','$Vitamins','$Fats','$Minerals','$Fiber','$how_it_read','$additional','$price')";
