...
$vendor_foods_present="SELECT * FROM breakfast where id='$id'";
...
echo "<tr class=\"header\">
    ...
    echo "<td><a style=\"text-decoration: none;\" href='update_breakfast.php?id=".$row_vendor_foods_present['food_id']."'>update Meal</a></td>";
    echo "<td><a style=\"text-decoration: none;\" href='delete_breakfast.php?id=".$row_vendor_foods_present['food_id']."'>Delete Meal</a></td>";
    echo "</tr>";
}
