...
//super global array
$id=$_GET['id'];
$vendor_id_take="SELECT * FROM snacks where food_id='$id'";
...
$query="INSERT INTO cus_order(vendor_id,food_id,cus_email,statues,food_time) values ('$vendor_id','$id','$email','Not Served','lunch')";
