...
<meta name="viewport" content="width=device-width, initial-scale=1.0"> 
    <title>Update breakfast meal</title>
...
include "link.php";
$id=$_GET['id'];
$foods="SELECT * FROM breakfast where food_id='$id'";
...
<?php
    if(isset($_POST['submit1'])){
        ...
        $query="UPDATE breakfast SET proteins='$pro',carbohydrates='$carbohydrates' ,vitmins='$Vitamins',fats='$Fats',minerals='$Minerals',fiber='$Fiber',how_it_read='$how_it_read',Additional='$additional',Price='$price' WHERE food_id='$id'";
