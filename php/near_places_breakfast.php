...
while($row_vendor_loc= mysqli_fetch_array($vendor_loc_query)){$vendor_id=$row_vendor_loc['id'];
  ...
  $vendor_foods="SELECT * FROM breakfast where id='$vendor_id'";
  $vendor_foods_query=mysqli_query($link,$vendor_foods);
        ...
        while($row_vendor_foods= mysqli_fetch_array($vendor_foods_query)){
            ...
            while($row_vendor_google= mysqli_fetch_array($vendor_google_loc_query)){
                ...
                echo "<tr>";
                echo "<td>".$row_vendor_foods['how_it_read']." also " .$row_vendor_foods['Additional']."</td>";
                echo "<td>".$row_vendor_foods['Price']."</td>";
                ...
                echo "<td><a style=\"text-decoration: none;\" href='make_order_breakfast.php?id=".$row_vendor_foods['food_id']."'>Make order</a></td>";
                echo "</tr>";
              }  
  }  
}
