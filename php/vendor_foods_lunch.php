...
$vendor_foods_present="SELECT * FROM lunch where id='$id'";
...
<th>Price</th>
    ...
    echo "<td><a style=\"text-decoration: none;\" href='update_lunch.php?id=".$row_vendor_foods_present['food_id']."'>update Meal</a></td>";
    echo "<td><a style=\"text-decoration: none;\" href='delete_lunch.php?id=".$row_vendor_foods_present['food_id']."'>Delete Meal</a></td>";
    echo "</tr>";
}
